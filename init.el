...
(custom-set-faces
 ...
 '(corfu-current ((t (:background "#0D0E16" :foreground "white" :box (:line-width (1 . 1) :color "turquoise1" :style released-button)))))
 '(cursor ((t (:background "turquoise1"))))
 '(custom-documentation ((t (:inherit default))))
 '(eldoc-highlight-function-argument ((t (:inherit bold :underline t))))
 '(embark-target ((t (:extend t :background "gray24"))))
 ...
 '(mode-line ((t (:background "black" :box (:line-width (1 . 1) :color "SlateBlue1")))))
