...
#+begin_src emacs-lisp
  (use-package eglot
    ...
    (add-to-list 'eglot-stay-out-of 'company) ;; this might be bad since eglot reaches for company naturally, and we can bridge company with cape
    (add-to-list 'eglot-stay-out-of 'corfu))
  ...
  (with-eval-after-load 'eglot
    ...
    (add-to-list 'eglot-server-programs '(java-ts-mode . eglot--eclipse-jdt-contact))
