...
** killing
*** kill whole word
TODO: fix this so it doesn't delete previous word if cursor is on 1st char of string
TODO: fix this so it actually deletes whole word regardless of global-super or subword-mode
#+begin_src emacs-lisp
