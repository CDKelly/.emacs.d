...
#+begin_src emacs-lisp
  (use-package ivy
    ...
    ;; (define-key ivy-mode-map (kbd "M-y") nil)
    )
#+end_src
*** ivy-hydra
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package counsel
    ...
    (defun my-minibuffer-hook()
      ;; I just want to use counsel-yank-pop in the minibuffer
      ;; Apparently, setting enable-recursive-minibuffers (above) wasn't enough
      (local-set-key (kbd "M-y") 'counsel-yank-pop))
        ...
        (let* ((envpath (or (getenv "PATH") path-separator))
          ...
          (cons 'eglot-eclipse-jdt
                (list (executable-find "java")
                      ...
                      "-Dmy.maven.local.repository=/Users/connorkelly/.m2/repository/"
